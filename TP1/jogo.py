...
class Jogo:
    ...
    def gameplay(self):
        while True:
            ...
            pause = pygame.Rect(10, 10, 4, 15)
            pygame.draw.rect(tela, "white", pause)
            pause.x += 7
            pygame.draw.rect(tela, "white", pause)
            font1 = pygame.font.Font(f"{os.getcwd()}/fontes/Pixeltype.ttf", 28)
            texto = font1.render("Esc", False, "white")
            tela.blit(texto, (28, 12))
    ...
    def final_de_jogo(self):
        ...
        while rodando:
            ...
            texto = fonte.render(f"Final de Jogo", False, "Black")
            tela.blit(texto, (150, 200))

            texto = fonte.render(f"Pontos: {self.player.pontos}", False, "Black")
            tela.blit(texto, (160, 300))

            font1 = pygame.font.Font(f"{os.getcwd()}/fontes/Pixeltype.ttf", 35)
            texto = font1.render(
                f"Pressione 'Enter' para tentar novamente", False, "Black"
            )
